...
1. **AI/ML:** LangGraph, LangChain, Groq, NLP, Scikit-Learn, Pandas.
2. **Testing:** System, HMI, Performance, and Regression Testing (JIRA, TestRail).
3. **Environment:** Python, Streamlit, Test-Bench & In-Vehicle Validation.
